    ...
    <footer className="site-footer">
      <div className="footer-about">
        ...
        <ul>
          <li>
            <a
              href="https://github.com/Erijesu0"
              target="_blank"
              rel="noreferrer"
            >
              Erijesu
          ...
          <li>
            <a
              href="https://github.com/officialjesprec"
              target="_blank"
              rel="noreferrer"
            >
              Jesutobiloba
          ...
          <li>
            <a
              href="https://github.com/FlourishM"
              target="_blank"
              rel="noreferrer"
            >
              FlourishM
          ...
          <li>
            <a
              href="https://github.com/ewenikekaosisochukwu-dotcom"
              target="_blank"
              rel="noreferrer"
            >
              Kaosisochukwu
          ...
          <li>
            <a
              href="https://github.com/tobiloba"
              target="_blank"
              rel="noreferrer"
            >
              Tobiloba
          ...
          <li>
            <a
              href="https://github.com/alebiosusamson95"
              target="_blank"
              rel="noreferrer"
            >
              Samson
